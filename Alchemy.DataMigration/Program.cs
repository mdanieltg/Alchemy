...
internal class Program
{
    ...
    {
        var readEffects = await CsvReader.ReadEffects(Path.Join(AlchemyDataPath, "effects.csv"));
        var readIngredients = await CsvReader.ReadIngredients(Path.Join(AlchemyDataPath, "ingredients.csv"));
        var ingredientsEffects = await CsvReader.ReadIngredientEffects(Path.Join(AlchemyDataPath, "ingredients-effects.csv"));
